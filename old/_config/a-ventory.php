...
define('BASE_DOMAIN',	'http://www.a-ventory.com');	// 운영 주소
define('BASE_URL',		'/');							// 기본 경로
define('UPLOAD_DOMAIN',	'http://data.a-ventory.com');	// 데이터 업로드
define('BASE_PATH',		'/var/www/a-ventory.com/');		// 기본환경
define('STATIC_PATH',	'/var/www/_static/');		// 기본환경
define('UPLOAD_PATH',	BASE_PATH.'upload/');			// 기본환경
define('SESSION_PATH',	'/var/www/session/');		// 기본환경
define('LANGUAGE',		'kr');			// 사이트 기본 언어
define('MULTI_LANGUAGE',false);			// 글로벌 사이트 여부
...
$_page = array(
	'intro'=>array(false,''),
	'about'=>array(false,''),
	'shop'=>array(false,'list','detail'),
	'order'=>array(false,''),
	'stockist'=>array(false,''),
	'member'=>array(false,'login','join'),
	'mypage'=>array(false,'login','join'),
	'guide'=>array(false,''),
