...
define('BASE_DOMAIN',	'http://www.layfram.com');	// 운영 주소
define('BASE_URL',		'/');							// 기본 경로
define('UPLOAD_DOMAIN',	'http://data.layfram.com');	// 데이터 업로드
define('BASE_PATH',		'/var/www/layfram.com/');		// 기본환경
define('STATIC_PATH',	'/var/www/_static/');		// 기본환경
define('UPLOAD_PATH',	'/var/www/data.layfram.com/');			// 기본환경
