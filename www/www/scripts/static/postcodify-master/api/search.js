            ...
            searchButton.click(function(event) {
                ...
                ajaxSuccess = function(data, textStatus, jqXHR) {
                    ...
                    // 검색 결과가 있는 경우...
                        ...
                        $('.addr-row').prepend("<span class='search_name'>도로명</span>");
                        
                        $('.old_addr-row').prepend("<span class='search_name'>지번</span>");
                        $('.addr-row').css({display:'flex',gap:'10px'});
                        $('.old_addr-row').css({display:'flex',gap:'20px'});
                        $('.code6, .code5, .addr-row, .old_addr-row').css('cursor', 'pointer');
