<?php
    ...
    $MOK_RESULT_REDIRECT_URL = "https://stg.adererror.com/kr/join";
    ...
    echo "
        <script>
            sessionStorage.setItem('mok-join', '".json_encode($result, JSON_UNESCAPED_UNICODE | JSON_UNESCAPED_SLASHES)."');
