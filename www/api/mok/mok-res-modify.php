<?php
    ...
    $MOK_RESULT_REDIRECT_URL = "https://stg.adererror.com/kr/my/modify";
    ...
    echo "
        <script>
            sessionStorage.setItem('mok-modify', '".json_encode($result, JSON_UNESCAPED_UNICODE | JSON_UNESCAPED_SLASHES)."');
