			...
			<section>
				<article>
					<form id="frm-modal-delivery">
						...
						<div class="form-inline inline-label">
							<input id="to_zipcode" type="number" name="to_zipcode" readonly required>
							<span class="control-label">우편번호</span>
						</div>

						<div class="form-inline inline-label">
							<input id="to_road_addr" type="text" name="to_road_addr" readonly required>
							<input id="to_lot_addr" type="hidden" name="to_lot_addr">
							<span class="control-label">주소</span>
						</div>

						<div class="form-inline inline-label">
							<input id="to_detail_addr" type="text" name="to_detail_addr" required>
			...
			$.ajax({
				...
				success: function (d) {
					if (d.code == 200) {
						...
						makeMsgNoti(config.language,'MSG_F_WRN_0037', null);
					}
				}
			});
		});
