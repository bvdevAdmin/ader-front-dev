		...
		<figure>
			...
			<figcaption>
				...
				<div class="store_addr-box">
					...
					<a href="${link_map}" target='_blank'><div class="addr-svg" data-link=""><img src="/images/ico-location-o.svg" alt=""><span data-i18n="ss_view_location">위치 보기</span></div></a>
				</div>
	...
	let innerHtml = `
		...
		<figure>
			<figcaption>
				...
				<div class="store_addr-box">
					<div class="store_addr">${store_addr}</div>
					<div class="addr-svg" data-link=""><a class="store_addr_link" href="${link_map}"><img src="/images/ico-location-o.svg" alt=""><span data-i18n="ss_view_location">위치 보기</span></a></div>
				</div>
				<div class="store_tel">${store_tel}<img src="/images/svg/store-phone.svg" alt=""></div>
				<div class="store_open_date">${store_sale_date}</div>
			</figcaption>
