<header>
	...
	<nav>
		...
		<dl class="tnb" id="tnb">
			...
			<dt><a href="/stockist">매장찾기</a></dt>
			<dt><a class="side" data-side="my">로그인</a><a href="/my">마이페이지</a></dt>
			<dt><a class="side" data-side="bluemark">Bluemark<span class="over"><span>Bluemark</span></span></a></dt>
			<dt><a class="side" data-side="search">검색</a></dt>
			<dt><a class="side" data-side="language">KR</a></dt>
			<dt><a href="/my/wishlist">Wishlist</a></dt>
			<dt><a class="side" data-side="shoppingbag">Shopping bag</a></dt>
		</dl>
		<ul class="tnb-mobile mobile" id="tnb-mobile">
			<li><a class="my" data-side="my">로그인</a><a href="/my" class="my">마이페이지</a></li>
	...
	<aside>
		...
		<section class="bluemark">
			<article>
				...
				<div class="buttons">
					<a href="/bluemark" class="btn certify no-over">블루마크 인증하기</a>
					<a href="/my/bluemark" class="btn no-over">블루마크 인증 내역</a>
				</div>
			</article>
		</section>
		<section class="language">
			<article>
				...
				<div class="buttons">
					<a href="//www.adererror.com" class="btn">한국어</a>
					<a href="//en.adererror.com" class="btn off">English</a>
					<a href="//cn.adererror.com" class="btn off">中文</a>
				</div>
			</article>
		</section>
		...
		<section class="my">
			<article class="login">
				...
				<section class="customer">
					<h2>고객서비스</h2>
					<a href="/notice" class="btn">공지사항</a>
					<a href="/faq" class="btn">자주 묻는 질문</a>
					<a href="/my/customer/qna" class="btn">문의하기</a>
				</section>
			</article>
		</section>
	</aside>
				...
				<article>
					<div class="tab">
						...
						<section class="recently">
							...
							<footer>
								<a href="/recently" class="btn">최근 본 제품으로 이동하기</a>
							</footer>
						</section>
						<section class="popular">
							...
							<footer>
								<a href="/best" class="btn">실시간 인기 제품으로 이동하기</a>
							</footer>
						</section>
						<section class="wishlist">
							...
							<footer>
								<a href="/my/wishlist" class="btn">위시리스트로 이동하기</a>
							</footer>
						</section>
					</div>
				</article>
...
<footer>
	<section>
		...
		<article class="rules">
			<h2>법적 고지사항</h2>
			<ul>
				<li><a href="/online-store-guide">온라인 스토어 이용가이드</a></li>
				<li><a href="/terms-of-use">이용 약관</a></li>
				<li><a href="/privacy-policy">개인정보 처리방침</a></li>
				<li><a href="/cookie-policy">쿠키정책</a></li>
			</ul>
		</article>
	...
	<p class="copyright">© ADERERROR 2023</p>
</footer>
